...
export function MapButtonSquare(props: { onOpen: React.MouseEventHandler<HTMLButtonElement> | undefined; label: string; icon: React.ReactElement<any, string | React.JSXElementConstructor<any>> | undefined }) {
    return (
